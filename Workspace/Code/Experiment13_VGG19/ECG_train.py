...
import drawing
#%% Input Arguments
parser = argparse.ArgumentParser(description='Experiment13(VGG19): Train the model for diagnosing the heart disease by the ECG.')
...
if __name__ == '__main__':
    ...
    for epoch in range(Args.epoch):
        ...
        F1.append(f1_test)
        if Args.show_plot:
            drawing.draw_result([Accuracy, F1], fig, ['VGG19 Accuracy', 'VGG19 F1'], True)
        # save
